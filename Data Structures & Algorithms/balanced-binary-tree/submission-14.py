...
class Solution:
    def isBalanced(self, root: Optional[TreeNode]) -> bool:
        ...
        def check_is_balanced(root):# Post Order Approach, which is O(n)
            ...
            h = 1 + max(h_left, h_right)# altura del "arbol" root actual (contabilizando el nodo actual root, que es padre de root.left y root.right. Dicho nodo padre recibe informacion de la recursion check_is_balanced)
